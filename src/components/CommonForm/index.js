...
const CommonForm = ({
  ...
  const scrollElementIntoView = (element, offset) => {
    //function to bring the confirmation message into view after submittion of form
  ...
  */
  const isValidEmail = (value) => {
    ...
    if (!validEmail) {
      ...
      validEmail &&
      /.*(?=.*@(?:duck\.com|protonmail\.com|anonaddy\.me|tuta\.io)).*/.test(
        value,
      )
    ) {
      setValidateEmail(true);
      setErrorEmail(
        "Use of this email address is not allowed. Please enter a non-anonymous email address / domain.",
      );
      return false;
    } else {
           ...
           <p>
            ...
            <div className="accounts_group">
             ...
             <Field type="text" className="text-field" id="linkedin" name="linkedin" placeholder="email" />
              ...
              <label htmlFor="role" className="form-name">
              ...
              <div role="group" className="formRight" aria-labelledby="select">
                <Field as="select" name="role">
                  <option defaultValue hidden className="custom-arrow">
                    Select your role
                  </option>
                  <option className="options" value="Architect">
                    Architect
                  </option>
                  <option className="options" value="Backend Engineer">
                    Backend Engineer
                  </option>
                  <option className="options" value="Business Operations">
                    Business Operations
                  </option>
                  <option className="options" value="Data Analyst">
                    Data Analyst
                  </option>
                  <option className="options" value="Designer">
                    Designer
                  </option>
                  <option className="options" value="Developer">
                    Developer
                  </option>
                  <option className="options" value="DevOps Engineer">
                    DevOps Engineer / SysAdmin
                  </option>
                  <option className="options" value="Executive">
                    Executive
                  </option>
                  <option className="options" value="Frontend Engineer">
                    Frontend Engineer
                  </option>
                  <option className="options" value="Fullstack Engineer">
                    Fullstack Engineer
                  </option>
                  <option className="options" value="IT Operations">
                    IT Operations
                  </option>
                  <option className="options" value="Manager">
                    Manager
                  </option>
                  <option className="options" value="Marketing">
                    Marketing
                  </option>
                  <option className="options" value="Media/Analyst">
                    Media/Analyst
                  </option>
                  <option className="options" value="Platform Engineer">
                    Platform Engineer
                  </option>
                  <option className="options" value="Professor/Academic">
                    Professor/Academic
                  </option>
                  <option className="options" value="Product Manager">
                    Product Manager
                  </option>
                  <option className="options" value="Sales">
                    Sales
                  </option>
                  <option className="options" value="Sales Engineer">
                    Sales Engineer
                  </option>
                  <option className="options" value="Site Reliability Engineer">
              ...
              <span>Subscribe to our newsletter</span>
                  ...
                  <div>
                    By providing my contact information, I authorize Layer5 to
                    contact me with communications about Layer5's products and
                    services.
                  </div>
                </>
              )}
              {form == "open-source-pricing" && (
                <>
                  ...
                  <label htmlFor="repository" className="form-name">
                    Please link the public repository of your OSS organization
                    (github, gitlab, etc.){" "}
                    <span className="required-sign">*</span>
                  </label>
                  <Field
                  ...
                  >
                    <Field
                      ...
                      aria-describedby="commercialization-description"
                    >
                      <option defaultValue hidden className="custom-arrow">
                        Select an option
                      </option>
                      ...
                      <option className="options" value="No">
                        No
                      </option>
                      <option className="options" value="Maybe">
                        Maybe
                      </option>
                    </Field>
                  </div>
                  ...
                  >
                    <label htmlFor="license" className="form-name">
                      What is the code distribution license for your OSS
                      project? <span className="required-sign">*</span>
                    </label>
                    <Field
                      as="select"
                      id="license"
                    ...
                    >
                      ...
                      <option value="GNU Affero General Public License v3.0">
                        GNU Affero General Public License v3.0
                      </option>
                      <option value="Apache 2.0">Apache 2.0</option>
                      <option value="BSD 2-Clause license">
                        BSD 2-Clause license
                      </option>
                      <option value="BSD-3-Clause license">
                      ...
                      <option value="GNU Lesser General Public License v3.0">
                      ...
                      <option value="Academic Free License v3.0">
                      ...
                      <option value="Creative Commons Zero v1.0 Universal">
                        Creative Commons Zero v1.0 Universal
                      </option>
                      <option value="Eclipse Public License 2.0">
                        Eclipse Public License 2.0
                      </option>
                      <option value="CeCILL Free Software License Agreement v2.1">
                        CeCILL Free Software License Agreement v2.1
                      </option>
                      <option value="Educational Community License v2.0">
                        Educational Community License v2.0
                      </option>
                      <option value="European Union Public License 1.2">
                        European Union Public License 1.2
                      </option>
                      <option value="ISC License">ISC License</option>
                      <option value="Microsoft Public License">
                        Microsoft Public License
                      </option>
                      <option value="Open Data Commons Open Database License v1.0">
                        Open Data Commons Open Database License v1.0
                      </option>
                      <option value="Common Development and Distribution License">
                        Common Development and Distribution License
                      </option>
                      <option value="Eiffel Forum License 2.0">
                        Eiffel Forum License 2.0
                      </option>
                      <option value="Adaptive Public License 1.0">
                        Adaptive Public License 1.0
                      </option>
                      <option value="Mulan Permissive Software License, Version 2">
                        Mulan Permissive Software License, Version 2
                      </option>
                    </Field>
                  </div>
                  <div>
                    Does this project have a pathway to commercialization? Your
                    organization can accept donations to sustain its work, but
                    it can't seek to make a profit by selling services, by
                    charging for enhancements or add-ons, or by other means
                    specifically for this project. If you don't meet this
                    criteria, Please reach out to Layer5 sales team who will
                    assist you find a partner program that may better fit your
                    needs.
                  </div>
                </>
              )}
              ...
              <Button
                ...
                className="btn"
                title={submit_button_title || "Submit"}
              />
            </Form>
          </Formik>
        </div>
