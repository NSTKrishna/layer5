    ...
    <Gnhwrapper id="projects">
      <Container>
          ...
          <Row>
            ...
            <Col $lg={6} $md={6} $sm={12}>
              <div className="hero-text">
                ...
                <p>
                  Meshery is the easiest way to get started with Nighthawk on
                  any cloud or platform.
                </p>
              </div>
            </Col>
          </Row>
        ...
        <div className="explain-1">
          ...
          <p>
            Nighthawk is a versatile HTTP load testing tool built out of a need
            to drill HTTP services with a constant request rate or with an
            adaptive request rate. Layer5 offers a custom distribution of
            Nighthawk with intelligent adaptive load controllers to
            automatically identify optimal configurations for your service mesh
            deployment. As a Layer 7 performance characterization tool
            supporting HTTP/HTTPS/HTTP2, Nighthawk is Meshery's (and Envoy's)
            load generator and is written in C++.
          </p>
          ...
          <Row className="align">
            <Col $lg={6} $md={6} $sm={12}>
              <div className="text">
                ...
                <p>
                  Meshery integrates Nighthawk as one of (currently) three
                  choices of load generator for characterizing and managing the
          ...
          <Row className="align">
            ...
            <Col $lg={6} $md={6} $sm={12}>
              <div className="text">
                ...
                <p>
                  As with a lot of open source projects, there is a lack of
                  consistent tooling. This makes it difficult to have easily
                  repeatable tests in that the building, deploying, and
                  maintaining of Nighthawk instances (potentially a fleet of
                  Nighthawk instances) is a burden without additional
                  tooling.{" "}
                </p>
                <Button
                  $primary
        ...
        <div className="explain-1">
          ...
          <p>
            Distributed load testing offers insight into system behaviors that
            arguably more accurately represent real world behaviors of services
            under load as that load comes from any number of sources.
          </p>
          <p>
            Engineers need multi-variate load generation and analysis techniques
            offered through distributed performance analysis. Nighthawk is being
            improved so that it can be horizontally scalable - such that
            multiple instances will be cognizant of one another and able to
            coordinate amongst each other. Nighthawk is growing in popularity
            with Layer5, Google, Red Hat, and AWS investing into it.
          </p>
          <div className="cards">
            <Row>
              <CardsContainer>
                <div className="card">
                  ...
                  <p>
                    ...
                    - Nighthawk integrates Meshery and Nighthawk. Through this
                    integration Meshery facilitates{" "}
                ...
                <div className="card">
                  ...
                  <p>
                    Nighthawk integrates with <Link to="/meshery">Meshery</Link>{" "}
                    and provides you with the ability to schedule performance
                    tests or insert them into your CI pipeline.
                  </p>
                  <p>
                    Adaptive analysis in which you may run multi-stage
                    performance tests and persist their results in a historical
                    archive is also enabled through integration with Meshery.
                  </p>
                </div>
              </CardsContainer>
            </Row>
          ...
          <Row>
            <Col $lg={6} $md={6} $sm={12}>
              <div className="text">
                ...
                <p>
                  Nighthawk will provide generally-available distributions of
                  Nighthawk under different architectures and platforms and
                  easy-to-use tooling for installation and operation. This will
                  include creating distributions of Nighthawk as well as
                  augmenting existing tooling, Meshery, to retrieve these
                  arch-specific packages and update their deployments.
                </p>
              </div>
            </Col>
            <Col $lg={6} $md={6} $sm={12}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="service">
                        ...
                        Deliver trusted, certified builds, distributed via the
                        most popular package managers: apt, yum, Homebrew, and
                        platforms: Docker and Meshery. Bridge Nighthawk’s C++
                        with the lingua franca of Cloud Native: Golang.
                      </td>
                    </tr>
                    <tr>
                      <td className="icon">
                    ...
                    <tr>
                      ...
                      <td className="service">
                        ...
                        Educate the ecosystem through the CNCF Service Mesh
                        Working Group.
                      </td>
                    </tr>
                  </tbody>
      ...
      <div className="callout">
        ...
        <p>
          ...
          Join us in the Cloud Native Computing Foundation's Service Mesh
          Working Group.
        </p>
