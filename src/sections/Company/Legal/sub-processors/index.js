    ...
    rows: [
      {
        ...
        dataShared:
          "Community Discussion Forum user account data, posts, and comments therein.",
      ...
      },
      {
        ...
        dataShared:
          "Layer5 Cloud user account data, including email addresses and hashed passwords.",
        hostingRegions: "United States",
        additionalInfo: "All accounts",
      },
      {
      ...
      },
      {
        name: "Slack",
        applicableServices:
          "Internal Communications, Customer support messaging",
        typeOfService: "Communication platform",
        dataShared: "Messages, files, and user information",
        hostingRegions: "United States",
        additionalInfo:
          "Used for internal team communication and customer support interactions.",
      },
      {
        name: "Celonis, Inc. (make.com)",
        applicableServices:
          "Layer5 Cloud (for workflow automation), open source community, Slack, and MailChimp",
        typeOfService: "Workflow automation platform",
        dataShared: "Workflow data and user information",
        hostingRegions: "United States",
        additionalInfo:
          "Used for automating workflows within Layer5 Cloud and open source community.",
      },
      {
        name: "ClickUp",
        ...
        hostingRegions: "United States",
        additionalInfo:
          "Used for managing internal projects and customer support tasks.",
      },
      {
        ...
        hostingRegions: "United States",
        additionalInfo:
          "Used for communicating service status and incidents to users.",
      },
    ],
  },
  {
        ...
        <Container>
          ...
          <Row>
            <Col $xs={12} $sm={12} $lg={12}>
              <p>
                This document outlines the sub-processors and service providers
                that Layer5 works with to deliver our services. For
                comprehensive information about how we collect, use, and protect
                your personal data, please refer to our{" "}
                <a href="/company/legal/privacy">Privacy Policy</a>.
              </p>
              <p>
                To deliver our services effectively, Layer5, Inc. partners with
                various sub-processors, subsidiaries, and support providers. We
                may share customer data with the entities listed below to
                support our platform's functionality and performance.
              </p>
              <h3>Data Hosting Locations</h3>
              <p>
                To provide our users with transparency about where their data is
                stored, Layer5 has defined primary hosting locations for its
                services. Data is stored in a specific region in the United
                States based on the service used.
              </p>
              <ul>
                <li>
                  <strong>Layer5 Cloud Account Data (cloud.layer5.io):</strong>{" "}
                  All user account data is hosted in the United States at an
                  Equinix datacenter in Dallas, Texas.
                </li>
                <li>
                  <strong>Kanvas (kanvas.new):</strong> Design data is hosted in
                  the United States at an Equinix datacenter in Dallas, Texas.
                </li>
                <li>
                  <strong>
                    Layer5 Discussion Forum Data (discuss.meshery.io):
                  </strong>{" "}
                  All forum data is hosted in the United States within the
                  Amazon Web Services (AWS) US East region.
                </li>
              </ul>
              <p>
                Please note that in some cases, certain third-party services
                (sub-processors) that we use to deliver our services may operate
                and process data in additional regions.
              </p>
              <h4>Can I change my data region?</h4>
              <p>
                Since data is physically stored in a predetermined location,
                once an account begins storing data it cannot be moved. If you
                want to switch to a different region, contact your local partner
                or Enterprise account manager to create a new account hosted in
                the region of your choice going forward.
              </p>
              {didLoad && (
                <SistentThemeProvider
                    ...
                    <Col md={12} sx={{ px: 0 }}>
                      {subProcessorData.map((section, index) => (
                        <StyledTableContainer key={index}>
                          <Table
                            size="small"
                            aria-label={`${section.section.toLowerCase().replace(/\s+/g, "-")}-table`}
                          >
