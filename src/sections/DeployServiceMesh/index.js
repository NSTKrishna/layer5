...
const ServiceMesh = () => {
  ...
  const submit = async () => {
    ...
    try {
      await axios.post("https://hook.us1.make.com/3t59ylhftnrmgrweonlr3cve5eltlaa5", {
        parentVal1,
        parentVal2,
        parentVal3,
        parentVal4,
              ...
              <div className="submit-btn">
                {
                  !submitFlag
                    ...
                    <>
                      ...
                      <Button $secondary disabled={isSubmitting} type="button" onClick={submit} title="Submit &rarr;"/>
                    </>
                }
                {
                  submitFlag
